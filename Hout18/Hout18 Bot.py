...
async def status_task():
    while True:
        ...
        await client.change_presence(activity=discord.Game('Bot by Sensen44'), status=discord.Status.online)
        await asyncio.sleep(3)
...
client.run('Njc2NjgwNDUxMDI4NTQ5NjMy.XkJNzQ.fWaauC44eiwUfSsg50_BwnCbcGU')